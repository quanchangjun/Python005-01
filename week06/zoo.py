...
3. 猫类要求有“叫声”、“是否适合作为宠物”以及“名字”三个属性，其中“叫声”作为类属性，除凶猛动物外都适合作为宠物，
   猫类继承自动物类。狗类属性与猫类相同，继承自动物类。
...
class Animal(object):
    ...
    is_ferocious_animal = False  # 是否属于凶猛动物
    ...
    def __getattribute__(self, item):
        if item == 'is_ferocious_animal' and self._shape >= SHAPE_MEDIUM and self._spec == SPEC_MEAT \
                and self._nature == NATURE_FEROCIOUS:
            self.is_ferocious_animal = True
